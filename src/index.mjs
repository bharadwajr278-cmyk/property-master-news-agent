...
const positiveDevelopment = /launch|acquir|purchase|land deal|development agreement|joint development|invest|approval|approv(?:es|ed|al)|clears?|sanction|tender|construction (?:starts|begins|completed)|work (?:starts|begins|completed)|inaugurat|commission|new (?:project|road|metro|corridor|flyover|underpass|expressway|housing)|expand|extension|upgrade|upgradation|overhaul|redevelop|revamp|connectivity|milestone|rera registration|possession|handover|complet(?:e|ed|ion)/i;
