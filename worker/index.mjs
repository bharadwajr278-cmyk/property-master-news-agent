...
const sources = [
  ...
  { publisher: "ETRealty", rssUrl: "https://realty.economictimes.indiatimes.com/rss/topstories", host: "realty.economictimes.indiatimes.com", logo: "https://realty.economictimes.indiatimes.com/favicon.ico" },
...
const relevance = /real estate|property|properties|realty|builder|developer|housing|residential|commercial|rera|project|plot|land|launch|metro|road|expressway|highway|flyover|underpass|airport|rrts|namo bharat|infrastructure|master plan|circle rate|stamp duty|registry|township|corridor|sewer|drain|water supply|landfill|revamp|repair|renovat|rehabilitat|upgrade|proptech|property technology|real estate startup|construction technology|m3m|sobha|shobha|amolik|godrej|dlf|prestige|bptp|ace group/i;
